...
system_name = org.wobh.common-lisp.games.hamurabi
system_path = ${XDG_DATA_HOME}/common-lisp/source
system_files = org.wobh.common-lisp.games.hamurabi.asd hamurabi.lisp hamurabi-test.lisp hamurabi-user.lisp
